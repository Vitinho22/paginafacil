    ...
    <>
      ...
      <div className="dashboard-content">
        <section className="card" style={{ padding: 28 }}>
          ...
          <h1 className="section-title" style={{ marginTop: 10 }}>Configurações</h1>
          <p className="muted" style={{ lineHeight: 1.7 }}>Gerencie sua conta e preferências da plataforma.</p>
